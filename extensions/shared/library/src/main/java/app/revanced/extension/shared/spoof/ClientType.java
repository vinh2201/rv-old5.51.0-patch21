...
public enum ClientType {
    ...
    ANDROID_NO_SDK(
            ...
            "20.26.46",
            "com.google.android.youtube/20.26.46 (Linux; U; Android " + Build.VERSION.RELEASE + ") gzip",
            false,
            true,
            "Android No SDK"
    ),
    ...
    IPADOS(5,
            ...
            "26.6.23G71",
            "21.30.5",
            "com.google.ios.youtube/21.30.5 (iPad17,4; U; CPU iPadOS 26_6 like Mac OS X; " + Locale.getDefault() + ")",
            false,
            true,
            "iPadOS"
    );
